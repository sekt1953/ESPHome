...
3. [peripherals](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Packet_Peripherals.md)
    ...
    3. [light_controller](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Packet_Peripherals.md)
4. [sensors](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
    1. [distance](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
    2. [environment](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md#environment)
    3. [presence](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md#presence)
