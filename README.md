...
3. [peripherals](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Packet_Peripherals.md)
    1. [peripherals/display]()
    2. [peripherals/motor_controller]()
    3. [peripherals/light_controller]()
4. [sensors](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
    1. [sensors/presence](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md#presence)
    2. [sensors/distance](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
    3. [sensors/environment](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md#environment)
