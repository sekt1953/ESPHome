...
4. [sensors](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
    1. [sensors/distance](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
    2. [sensors/environment](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md#environment)
    3. [sensors/presence](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md#presence)
