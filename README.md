...
1. [Mappestruktur](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Mappestruktur.md "Klik Her")
    * [Mapper og Filer](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Mappestruktur.md#mapper-og-filer)
    * [Kort Mappe Beskrivelse](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Mappestruktur.md#kort-mappe-beskrivelse)
    * [Særlige filer - secrets.yaml & .gitignore](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Mappestruktur.md#særlige-filer)
2. [Basic Package](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Basic.md)
    * [boards](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Basic.md#boards "Klik Her")
    * [common/core](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Basic.md#common-core "Klik Her")
    * [common/networks](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Basic.md#common-network)
3. [Controller Package](Package_Controller)
4. [Peripherals Package](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Packet_Peripherals.md)
...
5. [Sensors Package](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/Package_Sensors.md)
...
6. [ESPHome files](./Kodning_med_ESPHome_for_modelbane_folk_og_andre/ESPHome_files.md)
